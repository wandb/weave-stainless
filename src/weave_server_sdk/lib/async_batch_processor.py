...
T = TypeVar("T")
logger = logging.getLogger("weave_server_sdk.async_batch_processor")
    ...
    def _ensure_health_check_alive(self) -> None:
        ...
        if not self.health_check_thread.is_alive() and self.is_accepting_new_work():
            ...
            try:
                ...
                logger.error("Failed to revive health check thread", exc_info=e)
        ...
        while self.is_accepting_new_work():
            ...
            if not self.processing_thread.is_alive():
                ...
                try:
                    ...
                    logger.error("Failed to revive processing thread", exc_info=e)
