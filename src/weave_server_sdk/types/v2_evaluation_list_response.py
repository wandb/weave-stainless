...
__all__ = ["V2EvaluationListResponse", "V2EvaluationListResponseItem"]


class V2EvaluationListResponseItem(BaseModel):
    created_at: datetime
...
V2EvaluationListResponse: TypeAlias = List[V2EvaluationListResponseItem]
