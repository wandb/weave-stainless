...
class TestV2Ops:
    ...
    def test_method_create(self, client: WeaveTrace) -> None:
        v2_op = client.v2_ops.create(
            project="project",
            entity="entity",
        )
        assert_matches_type(V2OpCreateResponse, v2_op, path=["response"])
    ...
    def test_raw_response_create(self, client: WeaveTrace) -> None:
        response = client.v2_ops.with_raw_response.create(
            project="project",
            entity="entity",
        )
    ...
    def test_streaming_response_create(self, client: WeaveTrace) -> None:
        with client.v2_ops.with_streaming_response.create(
            project="project",
            entity="entity",
        ) as response:
    ...
    def test_path_params_create(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2_ops.with_raw_response.create(
                project="project",
                entity="",
            )
    ...
    def test_path_params_list(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2_ops.with_raw_response.list(
                project="project",
                entity="",
            )
    ...
    def test_raw_response_delete(self, client: WeaveTrace) -> None:
        response = client.v2_ops.with_raw_response.delete(
            object_id="object_id",
            entity="entity",
            project="project",
        )
    ...
    def test_streaming_response_delete(self, client: WeaveTrace) -> None:
        with client.v2_ops.with_streaming_response.delete(
            object_id="object_id",
            entity="entity",
            project="project",
        ) as response:
    ...
    def test_path_params_delete(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2_ops.with_raw_response.delete(
                object_id="object_id",
                entity="",
                project="project",
            )
    ...
    def test_raw_response_read(self, client: WeaveTrace) -> None:
        response = client.v2_ops.with_raw_response.read(
            digest="digest",
            entity="entity",
            project="project",
            object_id="object_id",
    ...
    def test_streaming_response_read(self, client: WeaveTrace) -> None:
        with client.v2_ops.with_streaming_response.read(
            digest="digest",
            entity="entity",
            project="project",
            object_id="object_id",
    ...
    def test_path_params_read(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2_ops.with_raw_response.read(
                digest="digest",
                entity="",
                project="project",
                object_id="object_id",
...
class TestAsyncV2Ops:
    ...
    async def test_method_create(self, async_client: AsyncWeaveTrace) -> None:
        v2_op = await async_client.v2_ops.create(
            project="project",
            entity="entity",
        )
        assert_matches_type(V2OpCreateResponse, v2_op, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2_ops.with_raw_response.create(
            project="project",
            entity="entity",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2_ops.with_streaming_response.create(
            project="project",
            entity="entity",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_create(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2_ops.with_raw_response.create(
                project="project",
                entity="",
            )
    ...
    async def test_path_params_list(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2_ops.with_raw_response.list(
                project="project",
                entity="",
            )
    ...
    async def test_method_delete(self, async_client: AsyncWeaveTrace) -> None:
        v2_op = await async_client.v2_ops.delete(
            object_id="object_id",
            entity="entity",
            project="project",
        )
    ...
    async def test_raw_response_delete(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2_ops.with_raw_response.delete(
            object_id="object_id",
            entity="entity",
            project="project",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2_ops.with_streaming_response.delete(
            object_id="object_id",
            entity="entity",
            project="project",
        ) as response:
    ...
    async def test_path_params_delete(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2_ops.with_raw_response.delete(
                object_id="object_id",
                entity="",
                project="project",
            )
    ...
    async def test_raw_response_read(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2_ops.with_raw_response.read(
            digest="digest",
            entity="entity",
            project="project",
            object_id="object_id",
    ...
    async def test_streaming_response_read(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2_ops.with_streaming_response.read(
            digest="digest",
            entity="entity",
            project="project",
            object_id="object_id",
    ...
    async def test_path_params_read(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2_ops.with_raw_response.read(
                digest="digest",
                entity="",
                project="project",
                object_id="object_id",
