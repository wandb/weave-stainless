...
class TestV2Test:
    ...
    def test_method_create(self, client: WeaveTrace) -> None:
        v2_test = client.v2_test.create(
            project="project",
            entity="entity",
        )
        assert_matches_type(V2TestCreateResponse, v2_test, path=["response"])
    ...
    def test_raw_response_create(self, client: WeaveTrace) -> None:
        response = client.v2_test.with_raw_response.create(
            project="project",
            entity="entity",
        )
        ...
        v2_test = response.parse()
        assert_matches_type(V2TestCreateResponse, v2_test, path=["response"])

    @parametrize
    def test_streaming_response_create(self, client: WeaveTrace) -> None:
        with client.v2_test.with_streaming_response.create(
            project="project",
            entity="entity",
        ) as response:
    ...
    def test_path_params_create(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2_test.with_raw_response.create(
                project="project",
                entity="",
            )
...
class TestAsyncV2Test:
    ...
    async def test_method_create(self, async_client: AsyncWeaveTrace) -> None:
        v2_test = await async_client.v2_test.create(
            project="project",
            entity="entity",
        )
        assert_matches_type(V2TestCreateResponse, v2_test, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2_test.with_raw_response.create(
            project="project",
            entity="entity",
        )
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        v2_test = await response.parse()
        assert_matches_type(V2TestCreateResponse, v2_test, path=["response"])

    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2_test.with_streaming_response.create(
            project="project",
            entity="entity",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_create(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2_test.with_raw_response.create(
                project="project",
                entity="",
            )
