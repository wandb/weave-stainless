...
class TestV2Models:
    ...
    def test_method_create(self, client: WeaveTrace) -> None:
        v2_model = client.v2_models.create(
            project="project",
            entity="entity",
            name="name",
            source_code="source_code",
        )
        assert_matches_type(V2ModelCreateResponse, v2_model, path=["response"])
    ...
    def test_raw_response_create(self, client: WeaveTrace) -> None:
        response = client.v2_models.with_raw_response.create(
            project="project",
            entity="entity",
            name="name",
            source_code="source_code",
        ...
        v2_model = response.parse()
        assert_matches_type(V2ModelCreateResponse, v2_model, path=["response"])

    @parametrize
    def test_streaming_response_create(self, client: WeaveTrace) -> None:
        with client.v2_models.with_streaming_response.create(
            project="project",
            entity="entity",
            name="name",
            source_code="source_code",
    ...
    def test_path_params_create(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2_models.with_raw_response.create(
                project="project",
                entity="",
                name="name",
                source_code="source_code",
    ...
    def test_method_list(self, client: WeaveTrace) -> None:
        v2_model_stream = client.v2_models.list(
            project="project",
            entity="entity",
        )
        assert_matches_type(JSONLDecoder[V2ModelListResponse], v2_model_stream, path=["response"])
    ...
    def test_raw_response_list(self, client: WeaveTrace) -> None:
        response = client.v2_models.with_raw_response.list(
            project="project",
            entity="entity",
        )
    ...
    def test_streaming_response_list(self, client: WeaveTrace) -> None:
        with client.v2_models.with_streaming_response.list(
            project="project",
            entity="entity",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_list(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2_models.with_raw_response.list(
                project="project",
                entity="",
            )
    ...
    def test_method_delete(self, client: WeaveTrace) -> None:
        v2_model = client.v2_models.delete(
            object_id="object_id",
            entity="entity",
            project="project",
        )
        assert_matches_type(V2ModelDeleteResponse, v2_model, path=["response"])
    ...
    def test_raw_response_delete(self, client: WeaveTrace) -> None:
        response = client.v2_models.with_raw_response.delete(
            object_id="object_id",
            entity="entity",
            project="project",
        )
    ...
    def test_streaming_response_delete(self, client: WeaveTrace) -> None:
        with client.v2_models.with_streaming_response.delete(
            object_id="object_id",
            entity="entity",
            project="project",
        ) as response:
    ...
    def test_path_params_delete(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2_models.with_raw_response.delete(
                object_id="object_id",
                entity="",
                project="project",
            )
    ...
    def test_method_read(self, client: WeaveTrace) -> None:
        v2_model = client.v2_models.read(
            digest="digest",
            entity="entity",
            project="project",
            object_id="object_id",
        )
        assert_matches_type(V2ModelReadResponse, v2_model, path=["response"])

    @parametrize
    def test_raw_response_read(self, client: WeaveTrace) -> None:
        response = client.v2_models.with_raw_response.read(
            digest="digest",
            entity="entity",
            project="project",
            object_id="object_id",
    ...
    def test_streaming_response_read(self, client: WeaveTrace) -> None:
        with client.v2_models.with_streaming_response.read(
            digest="digest",
            entity="entity",
            project="project",
            object_id="object_id",
    ...
    def test_path_params_read(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2_models.with_raw_response.read(
                digest="digest",
                entity="",
                project="project",
                object_id="object_id",
...
class TestAsyncV2Models:
    ...
    async def test_method_create(self, async_client: AsyncWeaveTrace) -> None:
        v2_model = await async_client.v2_models.create(
            project="project",
            entity="entity",
            name="name",
            source_code="source_code",
    ...
    async def test_raw_response_create(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2_models.with_raw_response.create(
            project="project",
            entity="entity",
            name="name",
            source_code="source_code",
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        v2_model = await response.parse()
        assert_matches_type(V2ModelCreateResponse, v2_model, path=["response"])

    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2_models.with_streaming_response.create(
            project="project",
            entity="entity",
            name="name",
            source_code="source_code",
    ...
    async def test_path_params_create(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2_models.with_raw_response.create(
                project="project",
                entity="",
                name="name",
                source_code="source_code",
    ...
    async def test_method_list(self, async_client: AsyncWeaveTrace) -> None:
        v2_model_stream = await async_client.v2_models.list(
            project="project",
            entity="entity",
        )
        assert_matches_type(AsyncJSONLDecoder[V2ModelListResponse], v2_model_stream, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2_models.with_raw_response.list(
            project="project",
            entity="entity",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2_models.with_streaming_response.list(
            project="project",
            entity="entity",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2_models.with_raw_response.list(
                project="project",
                entity="",
            )
    ...
    async def test_method_delete(self, async_client: AsyncWeaveTrace) -> None:
        v2_model = await async_client.v2_models.delete(
            object_id="object_id",
            entity="entity",
            project="project",
        )
    ...
    async def test_raw_response_delete(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2_models.with_raw_response.delete(
            object_id="object_id",
            entity="entity",
            project="project",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2_models.with_streaming_response.delete(
            object_id="object_id",
            entity="entity",
            project="project",
        ) as response:
    ...
    async def test_path_params_delete(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2_models.with_raw_response.delete(
                object_id="object_id",
                entity="",
                project="project",
            )
    ...
    async def test_method_read(self, async_client: AsyncWeaveTrace) -> None:
        v2_model = await async_client.v2_models.read(
            digest="digest",
            entity="entity",
            project="project",
            object_id="object_id",
    ...
    async def test_raw_response_read(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2_models.with_raw_response.read(
            digest="digest",
            entity="entity",
            project="project",
            object_id="object_id",
    ...
    async def test_streaming_response_read(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2_models.with_streaming_response.read(
            digest="digest",
            entity="entity",
            project="project",
            object_id="object_id",
    ...
    async def test_path_params_read(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2_models.with_raw_response.read(
                digest="digest",
                entity="",
                project="project",
                object_id="object_id",
