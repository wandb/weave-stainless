...
class TestEvaluationRuns:
    ...
    def test_method_create(self, client: WeaveTrace) -> None:
        evaluation_run = client.v2.evaluation_runs.create(
            project="project",
            entity="entity",
    ...
    def test_raw_response_create(self, client: WeaveTrace) -> None:
        response = client.v2.evaluation_runs.with_raw_response.create(
            project="project",
            entity="entity",
            evaluation="evaluation",
            model="model",
    ...
    def test_streaming_response_create(self, client: WeaveTrace) -> None:
        with client.v2.evaluation_runs.with_streaming_response.create(
            project="project",
            entity="entity",
            evaluation="evaluation",
            model="model",
    ...
    def test_path_params_create(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2.evaluation_runs.with_raw_response.create(
                project="project",
                entity="",
                evaluation="evaluation",
                model="model",
    ...
    def test_method_list(self, client: WeaveTrace) -> None:
        evaluation_run_stream = client.v2.evaluation_runs.list(
            project="project",
            entity="entity",
        )
        assert_matches_type(JSONLDecoder[EvaluationRunListResponse], evaluation_run_stream, path=["response"])
    ...
    def test_raw_response_list(self, client: WeaveTrace) -> None:
        response = client.v2.evaluation_runs.with_raw_response.list(
            project="project",
            entity="entity",
        )
    ...
    def test_streaming_response_list(self, client: WeaveTrace) -> None:
        with client.v2.evaluation_runs.with_streaming_response.list(
            project="project",
            entity="entity",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_list(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2.evaluation_runs.with_raw_response.list(
                project="project",
                entity="",
            )
    ...
    def test_method_delete(self, client: WeaveTrace) -> None:
        evaluation_run = client.v2.evaluation_runs.delete(
            project="project",
            entity="entity",
            body=["string"],
        )
        assert_matches_type(EvaluationRunDeleteResponse, evaluation_run, path=["response"])

    @parametrize
    def test_raw_response_delete(self, client: WeaveTrace) -> None:
        response = client.v2.evaluation_runs.with_raw_response.delete(
            project="project",
            entity="entity",
            body=["string"],
        )
    ...
    def test_streaming_response_delete(self, client: WeaveTrace) -> None:
        with client.v2.evaluation_runs.with_streaming_response.delete(
            project="project",
            entity="entity",
            body=["string"],
        ) as response:
    ...
    def test_path_params_delete(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2.evaluation_runs.with_raw_response.delete(
                project="project",
                entity="",
                body=["string"],
            )
    ...
    def test_method_finish(self, client: WeaveTrace) -> None:
        evaluation_run = client.v2.evaluation_runs.finish(
            evaluation_run_id="evaluation_run_id",
            entity="entity",
            project="project",
        )
        assert_matches_type(EvaluationRunFinishResponse, evaluation_run, path=["response"])
    ...
    def test_raw_response_finish(self, client: WeaveTrace) -> None:
        response = client.v2.evaluation_runs.with_raw_response.finish(
            evaluation_run_id="evaluation_run_id",
            entity="entity",
            project="project",
        )
    ...
    def test_streaming_response_finish(self, client: WeaveTrace) -> None:
        with client.v2.evaluation_runs.with_streaming_response.finish(
            evaluation_run_id="evaluation_run_id",
            entity="entity",
            project="project",
        ) as response:
    ...
    def test_path_params_finish(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2.evaluation_runs.with_raw_response.finish(
                evaluation_run_id="evaluation_run_id",
                entity="",
                project="project",
            )
    ...
    def test_method_read(self, client: WeaveTrace) -> None:
        evaluation_run = client.v2.evaluation_runs.read(
            evaluation_run_id="evaluation_run_id",
            entity="entity",
            project="project",
        )
        assert_matches_type(EvaluationRunReadResponse, evaluation_run, path=["response"])

    @parametrize
    def test_raw_response_read(self, client: WeaveTrace) -> None:
        response = client.v2.evaluation_runs.with_raw_response.read(
            evaluation_run_id="evaluation_run_id",
            entity="entity",
            project="project",
        )
    ...
    def test_streaming_response_read(self, client: WeaveTrace) -> None:
        with client.v2.evaluation_runs.with_streaming_response.read(
            evaluation_run_id="evaluation_run_id",
            entity="entity",
            project="project",
        ) as response:
    ...
    def test_path_params_read(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2.evaluation_runs.with_raw_response.read(
                evaluation_run_id="evaluation_run_id",
                entity="",
                project="project",
            )
...
class TestAsyncEvaluationRuns:
    ...
    async def test_method_create(self, async_client: AsyncWeaveTrace) -> None:
        evaluation_run = await async_client.v2.evaluation_runs.create(
            project="project",
            entity="entity",
            evaluation="evaluation",
            model="model",
    ...
    async def test_raw_response_create(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2.evaluation_runs.with_raw_response.create(
            project="project",
            entity="entity",
            evaluation="evaluation",
            model="model",
    ...
    async def test_streaming_response_create(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2.evaluation_runs.with_streaming_response.create(
            project="project",
            entity="entity",
            evaluation="evaluation",
            model="model",
    ...
    async def test_path_params_create(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2.evaluation_runs.with_raw_response.create(
                project="project",
                entity="",
                evaluation="evaluation",
                model="model",
    ...
    async def test_method_list(self, async_client: AsyncWeaveTrace) -> None:
        evaluation_run_stream = await async_client.v2.evaluation_runs.list(
            project="project",
            entity="entity",
        )
        assert_matches_type(AsyncJSONLDecoder[EvaluationRunListResponse], evaluation_run_stream, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2.evaluation_runs.with_raw_response.list(
            project="project",
            entity="entity",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2.evaluation_runs.with_streaming_response.list(
            project="project",
            entity="entity",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2.evaluation_runs.with_raw_response.list(
                project="project",
                entity="",
            )
    ...
    async def test_method_delete(self, async_client: AsyncWeaveTrace) -> None:
        evaluation_run = await async_client.v2.evaluation_runs.delete(
            project="project",
            entity="entity",
            body=["string"],
        )
    ...
    async def test_raw_response_delete(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2.evaluation_runs.with_raw_response.delete(
            project="project",
            entity="entity",
            body=["string"],
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2.evaluation_runs.with_streaming_response.delete(
            project="project",
            entity="entity",
            body=["string"],
        ) as response:
    ...
    async def test_path_params_delete(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2.evaluation_runs.with_raw_response.delete(
                project="project",
                entity="",
                body=["string"],
            )
    ...
    async def test_method_finish(self, async_client: AsyncWeaveTrace) -> None:
        evaluation_run = await async_client.v2.evaluation_runs.finish(
            evaluation_run_id="evaluation_run_id",
            entity="entity",
            project="project",
        )
    ...
    async def test_raw_response_finish(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2.evaluation_runs.with_raw_response.finish(
            evaluation_run_id="evaluation_run_id",
            entity="entity",
            project="project",
        )
    ...
    async def test_streaming_response_finish(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2.evaluation_runs.with_streaming_response.finish(
            evaluation_run_id="evaluation_run_id",
            entity="entity",
            project="project",
        ) as response:
    ...
    async def test_path_params_finish(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2.evaluation_runs.with_raw_response.finish(
                evaluation_run_id="evaluation_run_id",
                entity="",
                project="project",
            )
    ...
    async def test_method_read(self, async_client: AsyncWeaveTrace) -> None:
        evaluation_run = await async_client.v2.evaluation_runs.read(
            evaluation_run_id="evaluation_run_id",
            entity="entity",
            project="project",
        )
    ...
    async def test_raw_response_read(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2.evaluation_runs.with_raw_response.read(
            evaluation_run_id="evaluation_run_id",
            entity="entity",
            project="project",
        )
    ...
    async def test_streaming_response_read(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2.evaluation_runs.with_streaming_response.read(
            evaluation_run_id="evaluation_run_id",
            entity="entity",
            project="project",
        ) as response:
    ...
    async def test_path_params_read(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2.evaluation_runs.with_raw_response.read(
                evaluation_run_id="evaluation_run_id",
                entity="",
                project="project",
            )
