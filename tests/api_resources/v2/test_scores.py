...
class TestScores:
    ...
    def test_raw_response_create(self, client: WeaveTrace) -> None:
        response = client.v2.scores.with_raw_response.create(
            project="project",
            entity="entity",
            prediction_id="prediction_id",
            scorer="scorer",
    ...
    def test_streaming_response_create(self, client: WeaveTrace) -> None:
        with client.v2.scores.with_streaming_response.create(
            project="project",
            entity="entity",
            prediction_id="prediction_id",
            scorer="scorer",
    ...
    def test_path_params_create(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2.scores.with_raw_response.create(
                project="project",
                entity="",
                prediction_id="prediction_id",
                scorer="scorer",
    ...
    def test_method_list(self, client: WeaveTrace) -> None:
        score_stream = client.v2.scores.list(
            project="project",
            entity="entity",
        )
        assert_matches_type(JSONLDecoder[ScoreListResponse], score_stream, path=["response"])
    ...
    def test_raw_response_list(self, client: WeaveTrace) -> None:
        response = client.v2.scores.with_raw_response.list(
            project="project",
            entity="entity",
        )
    ...
    def test_streaming_response_list(self, client: WeaveTrace) -> None:
        with client.v2.scores.with_streaming_response.list(
            project="project",
            entity="entity",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_list(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2.scores.with_raw_response.list(
                project="project",
                entity="",
            )
    ...
    def test_method_delete(self, client: WeaveTrace) -> None:
        score = client.v2.scores.delete(
            project="project",
            entity="entity",
            body=["string"],
        )
        assert_matches_type(ScoreDeleteResponse, score, path=["response"])

    @parametrize
    def test_raw_response_delete(self, client: WeaveTrace) -> None:
        response = client.v2.scores.with_raw_response.delete(
            project="project",
            entity="entity",
            body=["string"],
        )
    ...
    def test_streaming_response_delete(self, client: WeaveTrace) -> None:
        with client.v2.scores.with_streaming_response.delete(
            project="project",
            entity="entity",
            body=["string"],
        ) as response:
    ...
    def test_path_params_delete(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2.scores.with_raw_response.delete(
                project="project",
                entity="",
                body=["string"],
            )
    ...
    def test_method_read(self, client: WeaveTrace) -> None:
        score = client.v2.scores.read(
            score_id="score_id",
            entity="entity",
            project="project",
        )
        assert_matches_type(ScoreReadResponse, score, path=["response"])

    @parametrize
    def test_raw_response_read(self, client: WeaveTrace) -> None:
        response = client.v2.scores.with_raw_response.read(
            score_id="score_id",
            entity="entity",
            project="project",
        )
    ...
    def test_streaming_response_read(self, client: WeaveTrace) -> None:
        with client.v2.scores.with_streaming_response.read(
            score_id="score_id",
            entity="entity",
            project="project",
        ) as response:
    ...
    def test_path_params_read(self, client: WeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            client.v2.scores.with_raw_response.read(
                score_id="score_id",
                entity="",
                project="project",
            )
...
class TestAsyncScores:
    ...
    async def test_method_create(self, async_client: AsyncWeaveTrace) -> None:
        score = await async_client.v2.scores.create(
            project="project",
            entity="entity",
            prediction_id="prediction_id",
            scorer="scorer",
    ...
    async def test_raw_response_create(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2.scores.with_raw_response.create(
            project="project",
            entity="entity",
            prediction_id="prediction_id",
            scorer="scorer",
    ...
    async def test_streaming_response_create(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2.scores.with_streaming_response.create(
            project="project",
            entity="entity",
            prediction_id="prediction_id",
            scorer="scorer",
    ...
    async def test_path_params_create(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2.scores.with_raw_response.create(
                project="project",
                entity="",
                prediction_id="prediction_id",
                scorer="scorer",
    ...
    async def test_method_list(self, async_client: AsyncWeaveTrace) -> None:
        score_stream = await async_client.v2.scores.list(
            project="project",
            entity="entity",
        )
        assert_matches_type(AsyncJSONLDecoder[ScoreListResponse], score_stream, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2.scores.with_raw_response.list(
            project="project",
            entity="entity",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2.scores.with_streaming_response.list(
            project="project",
            entity="entity",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2.scores.with_raw_response.list(
                project="project",
                entity="",
            )
    ...
    async def test_method_delete(self, async_client: AsyncWeaveTrace) -> None:
        score = await async_client.v2.scores.delete(
            project="project",
            entity="entity",
            body=["string"],
        )
    ...
    async def test_raw_response_delete(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2.scores.with_raw_response.delete(
            project="project",
            entity="entity",
            body=["string"],
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2.scores.with_streaming_response.delete(
            project="project",
            entity="entity",
            body=["string"],
        ) as response:
    ...
    async def test_path_params_delete(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2.scores.with_raw_response.delete(
                project="project",
                entity="",
                body=["string"],
            )
    ...
    async def test_method_read(self, async_client: AsyncWeaveTrace) -> None:
        score = await async_client.v2.scores.read(
            score_id="score_id",
            entity="entity",
            project="project",
        )
    ...
    async def test_raw_response_read(self, async_client: AsyncWeaveTrace) -> None:
        response = await async_client.v2.scores.with_raw_response.read(
            score_id="score_id",
            entity="entity",
            project="project",
        )
    ...
    async def test_streaming_response_read(self, async_client: AsyncWeaveTrace) -> None:
        async with async_client.v2.scores.with_streaming_response.read(
            score_id="score_id",
            entity="entity",
            project="project",
        ) as response:
    ...
    async def test_path_params_read(self, async_client: AsyncWeaveTrace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity` but received ''"):
            await async_client.v2.scores.with_raw_response.read(
                score_id="score_id",
                entity="",
                project="project",
            )
